...
<html lang="en">
  <head>
    ...
    <title>Aprendé Lenguaje de Señas</title>
  </head>
...
<div class="container">
  ...
  <h1 class="font-weight-light text-center text-lg-left mt-4 mb-0"><img src="images/header_principal.png" width="363" height="147" alt=""/>&nbsp; &nbsp;</h1>
  ...
  include("data_index.php");
	foreach ($info as $key=>$value){
		?>
	     <!-- Grid column -->
		  <div class="col-lg-4 col-md-6 mb-4"> <!--Col-6 Col-md-4 es para que salga 2 columnas mb-4 es para que deje espacio entre filas -->
			<a href="<?=$value['url_categoria']?>" >
				<img class="img-fluid z-depth-1" src="<?=$value['url_imagen']?>" alt="categorias">
			</a>
		  </div>
		<!-- Grid column -->	 
		<?php
